...
let fam: TintFamily | string = config?.defaultFamily ?? 'tamagui'
...
export const setTintFamilyDefault = () => {
  setTintFamily(config?.defaultFamily ?? 'tamagui')
}
